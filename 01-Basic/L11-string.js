...
const anotherCity2 = city.slice(0,4) // negative value also posible
console.log(anotherCity2);

const anotherCity3 = city.slice(-16,-4);
console.log(anotherCity3);

const newStringCity  = '   space    ' 
console.log(newStringCity);
console.log(newStringCity.trim()); // string ke aage or piche ke space ko remove kar deta he
